...
resource "aws_route53_record" "api_record" {
  ...
  alias {
    name                   = aws_api_gateway_domain_name.personal_website_api_domain.regional_domain_name
    zone_id                = aws_api_gateway_domain_name.personal_website_api_domain.regional_zone_id
